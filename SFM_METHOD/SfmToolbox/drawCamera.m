function drawCamera(Rt, w, h, f, scale, lineWidth,nCam)
...
loc = V(:,1)';
plotCamera('Location',loc, 'Orientation',Rt(1:3,1:3),'Size', 0.2,'Color',[0,0,0]);
text(loc(1,1)+0.3,loc(1,2)+0.3,loc(1,3)+0.3,int2str(nCam));
